    ...
    <div class="row">
      <div class="col">
        ...
        <div class="jumbotron">
          ...
          <p
            class="lead"
          >En esta area encontraras tarjetas con algunas notificaciones y datos que quizas puedan servirte.</p>
          ...
          <div class="row justify-content-center">
              ...
              <div class="card text-white bg-secondary mb-3">
                ...
                <div class="card-body">
                  <h3 class="text-center">
                    <span class="badge" v-bind:class="badgeAct">{{ actividades }}</span>
                  </h3>
            ...
            <div class="col-sm-4">
              <div class="card text-white bg-secondary mb-3">
                ...
                <div class="card-body">
                  <h3 class="text-center">
                    <span class="badge" v-bind:class="badgeEx">{{ examenes }}</span>
                  </h3>

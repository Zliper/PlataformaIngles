						...
						<div class="col-md-3 col-sm-12 inputs">
							<div class="card text-white bg-secondary">
								<div class="card-body">
									...
									<input type="number" class="form-control" onkeypress="return event.charCode >= 48" min="1" v-model="cuestionario.cantidad_reading" placeholder="Cantidad">
								</div>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-12 inputs">
							<div class="card text-white bg-secondary">
								<div class="card-body">
									...
									<input type="number" class="form-control" onkeypress="return event.charCode >= 48" min="1" v-model="cuestionario.cantidad_listening" placeholder="Cantidad">
								</div>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-12 inputs">
							<div class="card text-white bg-secondary">
								<div class="card-body">
									...
									<input type="number" class="form-control" onkeypress="return event.charCode >= 48" min="1" v-model="cuestionario.cantidad_writing" placeholder="Cantidad">
								</div>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		...
		checkForm() {
			...
			if (!this.cuestionario.cantidad_writing) this.errors.push('Cantidad de reactivos writing is required');
